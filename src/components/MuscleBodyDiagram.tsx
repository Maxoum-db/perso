...
export const FRONT_HALF: Array<[MuscleRegion | 'neutral', string]> = [
  ...
  ['pecUpper', 'M-3,64 C-11,64 -19,66 -25,70 C-28,74 -29,78 -28,81 C-22,82 -14,83 -6,84 C-4,80 -3,73 -3,64 Z'],
  // …puis la masse sterno-costale, qui plonge en s'arrondissant vers l'aisselle.
  ['pecLower', 'M-4,86 C-12,87 -21,90 -27,95 C-30,100 -30,105 -28,108 C-22,110 -14,108 -8,104 C-5,99 -4,93 -4,86 Z'],
  ...
  ['hipFlexors', 'M-15,139 C-14,152 -12,165 -9,176 C-6,180 -4,178 -3,174 C-5,162 -8,150 -10,140 C-12,137 -14,137 -15,139 Z'],
  ...
  ['vastusLat', 'M-27,180 C-33,199 -33,224 -28,245 C-24,249 -21,246 -20,241 C-21,214 -22,196 -23,181 C-25,178 -26,178 -27,180 Z'],
  ['rectusFemoris', 'M-17,180 C-21,201 -21,228 -16,248 C-13,250 -10,248 -10,244 C-9,220 -10,199 -11,182 C-13,178 -15,178 -17,180 Z'],
  ['adductors', 'M-8,182 C-12,199 -12,218 -10,233 C-7,235 -5,233 -4,230 C-4,213 -4,196 -5,183 C-6,180 -7,180 -8,182 Z'],
...
export const BACK_HALF: Array<[MuscleRegion | 'neutral', string]> = [
  ...
  ['lats', 'M-29,92 C-31,101 -30,110 -27,119 C-23,131 -16,142 -8,150 C-4,151 -2,149 -2,145 C-3,135 -6,124 -11,113 C-16,103 -22,94 -27,90 C-29,89 -30,90 -29,92 Z'],
  ...
  ['gluteMax', 'M-25,168 C-31,180 -30,196 -21,205 C-11,209 -3,201 -2,188 C-2,180 -2,173 -3,168 C-11,164 -20,164 -25,168 Z'],
  ['bicepsFemoris', 'M-26,207 C-30,228 -29,247 -24,260 C-21,262 -18,259 -18,254 C-18,233 -19,217 -21,208 C-23,205 -25,205 -26,207 Z'],
  ['hamsInner', 'M-15,207 C-17,228 -15,247 -13,260 C-10,262 -7,259 -6,254 C-5,235 -7,218 -10,208 C-12,205 -14,205 -15,207 Z'],
