...
const FRONT_HALF: Array<[MuscleRegion | 'neutral', string]> = [
  ...
  ['forearmFlex', 'M-39,142 C-47,155 -50,172 -47,188 L-39,186 C-38,170 -37,155 -36,144 Z'],
...
const BACK_HALF: Array<[MuscleRegion | 'neutral', string]> = [
  ...
  ['teres', 'M-29,80 C-24,83 -20,89 -18,96 C-20,99 -23,101 -26,103 C-28,94 -29,86 -29,80 Z'],
  ...
  ['forearmExt', 'M-41,142 C-49,155 -52,172 -48,188 L-40,186 C-39,170 -38,155 -38,144 Z'],
  ['neutral', 'M-45,190 C-51,196 -51,207 -45,211 C-39,207 -39,196 -45,190 Z'],
