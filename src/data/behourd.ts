...
// Acier 30 HGSA, set complet 33 kg — livraison 1er nov 2026
// ============================================================================
export const ARMOR_PIECES_TEMPLATE: ArmorPiece[] = [
  ...
  { slot: 'Brigantine (cuirasse plaquée)', icon: '🛡️', typical_weight_kg: 11, must_have: true, owned: false, pre_order: true, expected_delivery: '2026-11-01', notes: "📦 En cours — livraison 1er novembre 2026. Body armor brigantine — plaques d'acier rivetées sur tissu. Couvre torse + dos + flancs.", manufacturer: 'Armor Workshop Pavlo Kozak', product_code: '155 (set)' },
  { slot: 'Brigantine skirt (jupe)', icon: '🛡️', typical_weight_kg: 4, must_have: true, owned: false, pre_order: true, expected_delivery: '2026-11-01', notes: '📦 En cours — livraison 1er novembre 2026. Jupe brigantine — protection bassin + cuisses hautes.', manufacturer: 'Armor Workshop Pavlo Kozak', product_code: '155 (set)' },
  { slot: 'Full arms armor (bras + gantelets)', icon: '💪', typical_weight_kg: 7.5, must_have: true, owned: false, pre_order: true, expected_delivery: '2026-11-01', notes: '📦 En cours — livraison 1er novembre 2026. Set bras COMPLET : spallières + brassards + coudières + avant-bras + GANTELETS (mitons inclus).', manufacturer: 'Armor Workshop Pavlo Kozak', product_code: '155 (set)' },
  { slot: 'Full legs armor (jambes + sabatons)', icon: '🦵', typical_weight_kg: 8.5, must_have: true, owned: false, pre_order: true, expected_delivery: '2026-11-01', notes: '📦 En cours — livraison 1er novembre 2026. Set jambes COMPLET : cuissards + genouillères + jambières + SABATONS inclus.', manufacturer: 'Armor Workshop Pavlo Kozak', product_code: '155 (set)' },
