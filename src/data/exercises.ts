...
export const EXERCISE_LIBRARY: LibraryExercise[] = [
  ...
  { name: 'Shrugs haltères', groups: 'Trapèzes:1, Cou:0.4, Avant-bras:0.3', sets: 3, reps: '12-15' },
  ...
  { name: 'Pallof press', groups: 'Abdos/Core:1, Obliques:0.8', sets: 3, reps: '12/côté' },
  { name: 'Torso rotation (machine)', groups: 'Obliques:1, Abdos/Core:0.6', sets: 3, reps: '12/côté' },
  { name: 'Russian twist', groups: 'Obliques:1, Abdos/Core:0.7', sets: 3, reps: '20/côté' },
  ...
  { name: 'Suitcase carry (haltère 1 main)', groups: 'Obliques:1, Abdos/Core:0.8, Avant-bras:0.8, Trapèzes:0.5', sets: 3, reps: '30 m/côté' },
  ...
  { name: 'Slam ball', groups: 'Abdos/Core:1, Obliques:0.7, Épaules:0.7, Dos:0.5, Cardio:0.6', sets: 4, reps: '12' },
