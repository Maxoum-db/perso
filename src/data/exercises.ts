...
export const EXERCISE_LIBRARY: LibraryExercise[] = [
  ...
  { name: 'Moto — grande balade (route)', groups: 'Extenseurs du cou:0.7, Érecteurs du rachis:0.6, Adducteurs:0.6, Cou:0.5, Vaste latéral:0.5, Vaste médial:0.5, Grand fessier:0.5, Trapèze supérieur:0.4, Multifides:0.4, Carré des lombes:0.4, Grand droit:0.4, Obliques:0.4, Gracile:0.4, Moyen fessier:0.4, Fléchisseurs des doigts:0.4, Fléchisseurs avant-bras:0.4, Scalènes:0.3, Élévateur de la scapula:0.3, Transverse:0.3, Deltoïde antérieur:0.3, Tibial antérieur:0.3, Soléaire:0.3, Droit fémoral:0.3, Cardio:0.3', sets: 1, reps: '180 min', notes: 'Le mélange : des portions rapides où la nuque encaisse, des petites routes où les jambes travaillent. Speed Triple 1050, roadster nu, aucune protection au vent. Les genoux tiennent la moto et les bras restent souples — c’est la position qui permet de rouler trois heures sans avoir mal aux mains. Une pause toutes les heures, épaules relâchées sur les lignes droites. ⚠️ AC droite : ne pas verrouiller le bras droit sur le guidon, c’est lui qui encaisse les vibrations et le frein avant. ⚠️ Antéversion du bassin : les lombaires travaillent en extension prolongée — étirer les fléchisseurs de hanche à l’arrivée.', kind: 'activite' },
  { name: 'Moto — autoroute (vitesse stabilisée)', groups: 'Extenseurs du cou:0.8, Cou:0.6, Scalènes:0.6, Érecteurs du rachis:0.6, Adducteurs:0.6, Trapèze supérieur:0.5, Vaste latéral:0.5, Vaste médial:0.5, Élévateur de la scapula:0.4, Multifides:0.4, Grand droit:0.4, Grand fessier:0.4, Gracile:0.4, Fléchisseurs des doigts:0.4, Fléchisseurs avant-bras:0.3, Carré des lombes:0.3, Transverse:0.3, Obliques:0.3, Moyen fessier:0.3, Brachio-radial:0.3, Deltoïde antérieur:0.3, Soléaire:0.3, Cardio:0.3', sets: 1, reps: '90 min', notes: 'Le cou d’abord, mais sans exagérer : sur un roadster nu à vitesse stabilisée, le casque fait voile, la tête est tirée en arrière sans interruption et secouée par les turbulences. C’est l’entrée moto où la nuque encaisse le plus — mais elle reste sous le port du harnois, qui met 35 kg sur les épaules pendant une heure. Une autoroute fatigue le cou, elle ne le travaille pas au maximum. Mais ce sont les GENOUX qui encaissent la poussée du vent sur le buste : serrés sur le réservoir, ils dispensent les bras de retenir le corps, et c’est ce qui évite l’engourdissement d’avant-bras au bout d’une heure. Se coucher légèrement sur le réservoir décharge la nuque plus sûrement que n’importe quelle position de bras.', kind: 'activite' },
  { name: 'Moto — routes sinueuses (cols, petites routes)', groups: 'Adducteurs:0.8, Vaste latéral:0.7, Vaste médial:0.7, Grand fessier:0.7, Obliques:0.6, Gracile:0.6, Moyen fessier:0.6, Érecteurs du rachis:0.5, Multifides:0.5, Carré des lombes:0.5, Grand droit:0.5, Droit fémoral:0.5, Cardio:0.5, Extenseurs du cou:0.4, Cou:0.4, Fléchisseurs des doigts:0.4, Fléchisseurs avant-bras:0.4, Transverse:0.4, Rotateurs de hanche:0.4, Biceps fémoral:0.4, Soléaire:0.4, Tibial antérieur:0.3, Deltoïde antérieur:0.3, Brachio-radial:0.3', sets: 1, reps: '90 min', notes: 'Les JAMBES pilotent. Genoux serrés sur le réservoir à chaque appui, appui sur les repose-pieds à chaque changement d’angle, cuisses qui encaissent le freinage : c’est l’entrée où les adducteurs travaillent le plus de tout le catalogue. Isométrie longue, pas poussée maximale : les valeurs restent sous celles d’une heure en armure. Peu de vent — la nuque redescend d’autant. Serrer fort aux genoux décharge directement les avant-bras : quand la main fatigue, c’est presque toujours que les jambes ne tiennent plus. ⚠️ Dysplasie rotulienne : appui sur les repose-pieds, jamais en torsion sur le genou.', kind: 'activite' },
  { name: 'Moto — trajet urbain', groups: 'Fléchisseurs des doigts:0.6, Adducteurs:0.6, Fléchisseurs avant-bras:0.5, Cou:0.4, Extenseurs du cou:0.4, Érecteurs du rachis:0.4, Vaste latéral:0.4, Vaste médial:0.4, Trapèze supérieur:0.4, Extenseurs avant-bras:0.4, Brachio-radial:0.4, Grand fessier:0.4, Grand droit:0.3, Obliques:0.3, Deltoïde antérieur:0.3, Tibial antérieur:0.3, Élévateur de la scapula:0.3, Multifides:0.3, Soléaire:0.3, Cardio:0.3', sets: 1, reps: '30 min', notes: 'Main et jambes à égalité, et c’est le seul cas : l’embrayage et le frein travaillent en continu, mais à allure de marche ce sont les jambes qui tiennent la moto sous soi à chaque arrêt et à chaque demi-tour. Léger — à ne pas confondre avec une balade, sinon le mannequin croit à une sortie qui n’a pas eu lieu.', kind: 'activite' },
