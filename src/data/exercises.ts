...
export const EXERCISE_LIBRARY: LibraryExercise[] = [
  ...
  { name: 'Curl haltères marteau', groups: 'Brachial:1, Brachio-radial:1, Biceps:0.7, Fléchisseurs avant-bras:0.5, Fléchisseurs des doigts:0.4, Rond pronateur:0.4, Extenseurs avant-bras:0.3, Deltoïde antérieur:0.3', sets: 3, reps: '12' },
  ...
  { name: 'Curl inversé (prise pronation)', groups: 'Brachio-radial:1, Extenseurs avant-bras:0.8, Brachial:0.7, Rond pronateur:0.6, Biceps:0.5, Fléchisseurs des doigts:0.4, Fléchisseurs avant-bras:0.3', sets: 3, reps: '12' },
  { name: 'Extensions triceps poulie haute (corde)', groups: 'Triceps latéral:1, Triceps longue portion:0.7, Extenseurs avant-bras:0.3, Fléchisseurs des doigts:0.3, Grand droit:0.3', sets: 3, reps: '12' },
  { name: 'Extensions triceps poulie haute (barre droite)', groups: 'Triceps latéral:1, Triceps longue portion:0.6, Extenseurs avant-bras:0.3, Fléchisseurs des doigts:0.3, Grand droit:0.3', sets: 4, reps: '12' },
  ...
  { name: 'Flexions de poignets', groups: 'Fléchisseurs avant-bras:1, Fléchisseurs des doigts:0.7, Rond pronateur:0.4, Brachio-radial:0.3', sets: 3, reps: '20', adaptable: true },
  ...
  { name: 'Fentes marchées haltères', groups: 'Vaste latéral:1, Vaste médial:0.9, Grand fessier:0.8, Droit fémoral:0.6, Moyen fessier:0.5, Adducteurs:0.5, Biceps fémoral:0.4, Fléchisseurs avant-bras:0.4, Soléaire:0.4, Obliques:0.4, Ischios internes:0.4, Trapèze supérieur:0.3, Tibial antérieur:0.3', sets: 3, reps: '12/jambe' },
  ...
  { name: 'Adducteurs (machine)', groups: 'Adducteurs:1, Gracile:0.7, Ischios internes:0.4, Rotateurs de hanche:0.3, Grand droit:0.3', sets: 3, reps: '15' },
  ...
  { name: 'Crunch à la machine', groups: 'Grand droit:1, Obliques:0.4, Psoas-iliaque:0.3', sets: 3, reps: '15' },
  ...
  { name: 'Balancier à la kettlebell', groups: 'Grand fessier:1, Biceps fémoral:0.8, Ischios internes:0.7, Érecteurs du rachis:0.5, Grand droit:0.5, Adducteurs:0.5, Grand dorsal:0.5, Fléchisseurs avant-bras:0.4, Trapèze supérieur:0.4, Obliques:0.4, Deltoïde postérieur:0.3', sets: 4, reps: '15' },
  ...
  { name: 'Soulevé de terre sumo', groups: 'Grand fessier:1, Adducteurs:0.9, Vaste latéral:0.8, Vaste médial:0.8, Érecteurs du rachis:0.7, Rotateurs de hanche:0.6, Ischios internes:0.6, Biceps fémoral:0.5, Gracile:0.5, Trapèze supérieur:0.5, Moyen fessier:0.5, Grand dorsal:0.5, Multifides:0.5, Droit fémoral:0.5, Fléchisseurs avant-bras:0.4, Trapèze moyen:0.4, Tenseur du fascia lata:0.4', sets: 4, reps: '6', notes: 'Prise étroite, pieds larges : moins de flexion lombaire que le conventionnel.' },
  { name: 'Soulevé de terre trap bar', groups: 'Vaste latéral:1, Vaste médial:1, Grand fessier:1, Biceps fémoral:0.7, Ischios internes:0.6, Droit fémoral:0.6, Trapèze supérieur:0.6, Érecteurs du rachis:0.6, Fléchisseurs avant-bras:0.5, Adducteurs:0.5, Grand dorsal:0.5, Trapèze moyen:0.4, Soléaire:0.3', sets: 4, reps: '8', notes: 'Barre hexagonale : dos plus vertical, excellent compromis pour les lombaires.' },
  ...
  { name: 'Extensions de poignets', groups: 'Extenseurs avant-bras:1, Fléchisseurs des doigts:0.4, Brachio-radial:0.3', sets: 3, reps: '20', notes: 'Compense le travail de préhension — prévention épicondylite.', adaptable: true },
  ...
  { name: 'Extension de poignet excentrique (haltère)', groups: 'Extenseurs avant-bras:1, Fléchisseurs des doigts:0.4, Brachio-radial:0.3', sets: 3, reps: '12/bras', notes: 'On monte avec l’aide de l’autre main, on redescend seul en 3 s. C’est l’excentrique lent qui remet un tendon en état — le protocole de référence sur l’épicondylite.' },
  { name: 'Extension des doigts à l’élastique', groups: 'Extenseurs avant-bras:1, Fléchisseurs des doigts:0.4, Brachio-radial:0.3', sets: 3, reps: '25', notes: 'Petit élastique autour des doigts, on ouvre la main contre la résistance. À faire juste après l’anneau de préhension.', adaptable: true },
  ...
  { name: 'Développé incliné à la barre guidée', groups: 'Pectoral supérieur:1, Deltoïde antérieur:0.6, Triceps latéral:0.4, Dentelé antérieur:0.3, Triceps longue portion:0.3', sets: 4, reps: '10' },
  ...
  { name: 'Tirage buste penché aux haltères', groups: 'Grand dorsal:1, Trapèze moyen:0.6, Rhomboïdes:0.5, Biceps:0.5, Brachial:0.5, Grand rond:0.5, Érecteurs du rachis:0.5, Deltoïde postérieur:0.4, Fléchisseurs avant-bras:0.4, Biceps fémoral:0.4, Ischios internes:0.4, Trapèze inférieur:0.3, Brachio-radial:0.3', sets: 4, reps: '10' },
  { name: 'Soulevé de terre jambes tendues aux haltères', groups: 'Biceps fémoral:1, Ischios internes:0.9, Grand fessier:0.8, Érecteurs du rachis:0.6, Adducteurs:0.5, Fléchisseurs avant-bras:0.4, Trapèze moyen:0.3, Grand dorsal:0.3, Gastrocnémiens:0.3', sets: 3, reps: '12' },
  ...
  { name: 'Curl incliné aux haltères', groups: 'Biceps:1, Brachial:0.5, Brachio-radial:0.4, Coraco-brachial:0.3, Fléchisseurs avant-bras:0.3, Fléchisseurs des doigts:0.3', sets: 3, reps: '12', notes: 'Bras en arrière du buste : étirement maximal de la longue portion.' },
  ...
  { name: 'Bûcheron à la poulie (haut vers bas)', groups: 'Obliques:1, Grand droit:0.7, Grand dorsal:0.5, Deltoïde antérieur:0.4, Grand fessier:0.4, Trapèze moyen:0.3, Triceps latéral:0.3, Moyen fessier:0.3, Triceps longue portion:0.3', sets: 3, reps: '12/côté', notes: 'La rotation part des hanches, pas des bras. C’est le geste de frappe en armure.' },
