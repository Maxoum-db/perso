...
export const EXERCISE_LIBRARY: LibraryExercise[] = [
  ...
  { name: 'Moto — autoroute (vitesse stabilisée)', groups: 'Extenseurs du cou:1, Cou:0.8, Trapèze supérieur:0.7, Scalènes:0.7, Érecteurs du rachis:0.7, Élévateur de la scapula:0.6, Fléchisseurs des doigts:0.6, Fléchisseurs avant-bras:0.6, Deltoïde antérieur:0.5, Multifides:0.5, Grand droit:0.5, Extenseurs avant-bras:0.5, Brachio-radial:0.5, Carré des lombes:0.4, Transverse:0.4, Coiffe des rotateurs:0.4, Triceps latéral:0.4, Obliques:0.4, Adducteurs:0.4, Trapèze moyen:0.3, Rhomboïdes:0.3, Tibial antérieur:0.3, Soléaire:0.3, Grand fessier:0.3, Cardio:0.3', sets: 1, reps: '90 min', notes: 'Le cou, et presque rien d’autre. Sur un roadster nu à vitesse stabilisée, le casque fait voile : la tête est tirée en arrière sans interruption et secouée par les turbulences, pendant que le reste du corps ne fait que tenir. C’est la seule entrée où la nuque est MOTRICE et non stabilisatrice — deux heures d’autoroute valent une séance de sangle cervicale, sans l’avoir choisie. Se coucher légèrement sur le réservoir décharge la nuque plus sûrement que n’importe quelle position de bras.', kind: 'activite' },
  { name: 'Moto — routes sinueuses (cols, petites routes)', groups: 'Adducteurs:1, Vaste latéral:0.9, Vaste médial:0.9, Obliques:0.8, Fléchisseurs des doigts:0.7, Gracile:0.7, Grand fessier:0.7, Fléchisseurs avant-bras:0.7, Moyen fessier:0.6, Grand droit:0.6, Multifides:0.6, Carré des lombes:0.6, Érecteurs du rachis:0.6, Deltoïde antérieur:0.6, Droit fémoral:0.5, Transverse:0.5, Cardio:0.5, Brachio-radial:0.5, Extenseurs avant-bras:0.5, Soléaire:0.5, Tibial antérieur:0.5, Extenseurs du cou:0.5, Cou:0.5, Rotateurs de hanche:0.4, Biceps fémoral:0.4, Triceps latéral:0.4, Trapèze supérieur:0.4', sets: 1, reps: '90 min', notes: 'Les JAMBES pilotent. Genoux serrés sur le réservoir à chaque appui, appui sur les repose-pieds à chaque changement d’angle, cuisses qui encaissent le freinage : c’est la seule entrée où les adducteurs sont moteurs. Peu de vent — la nuque redescend d’autant. Serrer fort aux genoux décharge directement les avant-bras : quand la main fatigue, c’est souvent que les jambes ne tiennent plus. ⚠️ Dysplasie rotulienne : appui sur les repose-pieds, jamais en torsion sur le genou.', kind: 'activite' },
