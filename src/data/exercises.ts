...
export const EXERCISE_LIBRARY: LibraryExercise[] = [
  ...
  { name: 'Moto — grande balade (route)', groups: 'Extenseurs du cou:0.8, Érecteurs du rachis:0.7, Adducteurs:0.7, Cou:0.6, Vaste latéral:0.6, Vaste médial:0.6, Grand fessier:0.6, Trapèze supérieur:0.5, Multifides:0.5, Carré des lombes:0.5, Grand droit:0.5, Obliques:0.5, Gracile:0.5, Moyen fessier:0.5, Fléchisseurs des doigts:0.5, Fléchisseurs avant-bras:0.5, Scalènes:0.4, Élévateur de la scapula:0.4, Transverse:0.4, Deltoïde antérieur:0.4, Tibial antérieur:0.4, Soléaire:0.4, Droit fémoral:0.4, Extenseurs avant-bras:0.4, Brachio-radial:0.4, Triceps latéral:0.3, Cardio:0.3', sets: 1, reps: '180 min', notes: 'Le mélange : des portions rapides où la nuque encaisse, des petites routes où les jambes travaillent. Speed Triple 1050, roadster nu, aucune protection au vent. Les genoux tiennent la moto et les bras restent souples — c’est la position qui permet de rouler trois heures sans avoir mal aux mains. Une pause toutes les heures, épaules relâchées sur les lignes droites. ⚠️ AC droite : ne pas verrouiller le bras droit sur le guidon, c’est lui qui encaisse les vibrations et le frein avant. ⚠️ Antéversion du bassin : les lombaires travaillent en extension prolongée — étirer les fléchisseurs de hanche à l’arrivée.', kind: 'activite' },
  { name: 'Moto — autoroute (vitesse stabilisée)', groups: 'Extenseurs du cou:1, Cou:0.8, Adducteurs:0.7, Érecteurs du rachis:0.7, Scalènes:0.7, Trapèze supérieur:0.6, Vaste latéral:0.6, Vaste médial:0.6, Élévateur de la scapula:0.5, Multifides:0.5, Grand droit:0.5, Grand fessier:0.5, Gracile:0.5, Fléchisseurs des doigts:0.4, Fléchisseurs avant-bras:0.4, Carré des lombes:0.4, Transverse:0.4, Obliques:0.4, Moyen fessier:0.4, Brachio-radial:0.3, Extenseurs avant-bras:0.3, Coiffe des rotateurs:0.3, Deltoïde antérieur:0.3, Triceps latéral:0.3, Tibial antérieur:0.3, Soléaire:0.3, Cardio:0.3', sets: 1, reps: '90 min', notes: 'Le cou d’abord : sur un roadster nu à vitesse stabilisée, le casque fait voile, la tête est tirée en arrière sans interruption et secouée par les turbulences. C’est la seule entrée où la nuque est MOTRICE — deux heures d’autoroute valent une séance de sangle cervicale. Mais ce sont les GENOUX qui encaissent la poussée du vent sur le buste : serrés sur le réservoir, ils dispensent les bras de retenir le corps, et c’est ce qui évite l’engourdissement d’avant-bras au bout d’une heure. Se coucher légèrement sur le réservoir décharge la nuque plus sûrement que n’importe quelle position de bras.', kind: 'activite' },
  { name: 'Moto — routes sinueuses (cols, petites routes)', groups: 'Adducteurs:1, Vaste latéral:0.9, Vaste médial:0.9, Grand fessier:0.8, Obliques:0.8, Gracile:0.7, Moyen fessier:0.7, Droit fémoral:0.6, Grand droit:0.6, Multifides:0.6, Carré des lombes:0.6, Érecteurs du rachis:0.6, Biceps fémoral:0.5, Fléchisseurs des doigts:0.5, Fléchisseurs avant-bras:0.5, Transverse:0.5, Soléaire:0.5, Tibial antérieur:0.5, Extenseurs du cou:0.5, Cou:0.5, Rotateurs de hanche:0.5, Cardio:0.5, Deltoïde antérieur:0.4, Brachio-radial:0.4, Extenseurs avant-bras:0.4, Triceps latéral:0.3, Trapèze supérieur:0.3', sets: 1, reps: '90 min', notes: 'Les JAMBES pilotent. Genoux serrés sur le réservoir à chaque appui, appui sur les repose-pieds à chaque changement d’angle, cuisses qui encaissent le freinage : c’est la seule entrée où les adducteurs sont moteurs. Peu de vent — la nuque redescend d’autant. Serrer fort aux genoux décharge directement les avant-bras : quand la main fatigue, c’est presque toujours que les jambes ne tiennent plus. ⚠️ Dysplasie rotulienne : appui sur les repose-pieds, jamais en torsion sur le genou.', kind: 'activite' },
