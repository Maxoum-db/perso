...
export const EXERCISE_LIBRARY: LibraryExercise[] = [
  ...
  // ── Natation ──────────────────────────────────────────────────────────────
  { name: 'Crawl (nage libre)', groups: 'Grand dorsal:1, Deltoïde postérieur:0.8, Deltoïde latéral:0.6, Cardio:0.8, Triceps:0.5, Grand droit:0.5', sets: 1, reps: '20 min' },
  { name: 'Brasse', groups: 'Grand pectoral:1, Cardio:0.8, Adducteurs:0.7, Grand dorsal:0.5, Deltoïde antérieur:0.4', sets: 1, reps: '20 min' },
  { name: 'Dos crawlé', groups: 'Grand dorsal:1, Deltoïde postérieur:0.7, Trapèze moyen:0.5, Cardio:0.7', sets: 1, reps: '15 min' },
  { name: 'Papillon', groups: 'Deltoïde latéral:1, Deltoïde antérieur:0.8, Grand pectoral:0.8, Grand dorsal:0.7, Grand droit:0.5', sets: 1, reps: '10 min' },
  { name: 'Jambes avec planche (natation)', groups: 'Droit fémoral:1, Grand fessier:0.6, Gastrocnémiens:0.5, Grand droit:0.4', sets: 4, reps: '50 m' },
  { name: 'Nage bras seuls (pull buoy)', groups: 'Grand dorsal:1, Deltoïde postérieur:0.6, Triceps:0.5, Fléchisseurs avant-bras:0.3', sets: 4, reps: '50 m' },
  { name: 'Nage avec plaquettes', groups: 'Grand dorsal:1, Deltoïde latéral:0.8, Deltoïde postérieur:0.7, Grand pectoral:0.5', sets: 4, reps: '50 m' },
  { name: 'Nage en eau libre', groups: 'Grand dorsal:1, Cardio:0.9, Deltoïde postérieur:0.7, Grand droit:0.4', sets: 1, reps: '30 min' },
  { name: 'Aquagym / marche aquatique', groups: 'Cardio:1, Quadriceps:0.4, Deltoïde latéral:0.3', sets: 1, reps: '30 min' },
