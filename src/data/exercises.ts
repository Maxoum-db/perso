...
export const EXERCISE_LIBRARY: LibraryExercise[] = [
  ...
  { name: 'Haussements d’épaules aux haltères', groups: 'Trapèze supérieur:1, Élévateur de la scapula:0.7, Trapèze moyen:0.5, Cou:0.4, Fléchisseurs avant-bras:0.4, Extenseurs du cou:0.4, Rhomboïdes:0.3, Érecteurs du rachis:0.3', sets: 3, reps: '15' },
  ...
  { name: 'Marche du fermier', groups: 'Fléchisseurs des doigts:1, Fléchisseurs avant-bras:0.9, Trapèze supérieur:0.8, Carré des lombes:0.7, Obliques:0.6, Érecteurs du rachis:0.6, Moyen fessier:0.6, Grand droit:0.5, Extenseurs avant-bras:0.5, Élévateur de la scapula:0.5, Transverse:0.5, Extenseurs du cou:0.5, Vaste latéral:0.4, Vaste médial:0.4, Cou:0.4, Brachio-radial:0.4, Trapèze moyen:0.4, Soléaire:0.4, Multifides:0.4, Grand fessier:0.4, Gastrocnémiens:0.3, Droit fémoral:0.3, Adducteurs:0.3', sets: 4, reps: '30 m' },
  ...
  { name: 'Nage en eau libre', groups: 'Grand dorsal:1, Cardio:0.9, Grand pectoral:0.7, Obliques:0.6, Deltoïde postérieur:0.6, Coiffe des rotateurs:0.5, Triceps latéral:0.5, Extenseurs du cou:0.5, Cou:0.4, Trapèze moyen:0.4, Triceps longue portion:0.3, Grand fessier:0.3', sets: 1, reps: '30 min', notes: 'Endurance + thermorégulation. Repères visuels réguliers.', kind: 'activite' },
  ...
  // ── Vie quotidienne ───────────────────────────────────────────────────────
  //
  // Les tâches de la maison. Elles ne sont pas de l'entraînement, et c'est
  // justement pour ça qu'elles comptent : trois heures à déménager des meubles
  // fatiguent le dos et les avant-bras autant qu'une séance, et ne laissaient
  // aucune trace — ni au journal, ni sur le mannequin, ni dans la charge. Le
  // lendemain, l'application proposait une séance lourde sur des muscles déjà
  // vidés la veille, sans rien savoir.
  //
  // `kind: 'activite'` comme la nage et le bois : elles pèsent dans la
  // récupération, mais le générateur ne les propose jamais comme exercice — on
  // ne place pas « passer l'aspirateur » au milieu d'un push.
  //
  ...
  { name: 'Vie quotidienne — bricolage et outillage', groups: 'Fléchisseurs avant-bras:0.7, Deltoïde antérieur:0.6, Fléchisseurs des doigts:0.6, Grand droit:0.4, Érecteurs du rachis:0.4, Brachio-radial:0.4, Triceps latéral:0.4, Obliques:0.4, Trapèze supérieur:0.3, Biceps:0.3', sets: 1, reps: '60 min', notes: 'Préhension et positions tenues. Les accroupissements répétés comptent autant que l’outil.', kind: 'activite' },
  { name: 'Vie quotidienne — peinture murs et plafond', groups: 'Deltoïde antérieur:0.9, Deltoïde latéral:0.8, Coiffe des rotateurs:0.6, Trapèze supérieur:0.6, Fléchisseurs avant-bras:0.5, Grand droit:0.4, Érecteurs du rachis:0.4, Dentelé antérieur:0.4, Brachio-radial:0.3, Triceps latéral:0.3', sets: 1, reps: '60 min', notes: '⚠️ AC droite : bras en l’air prolongé, exactement ce qui la réveille. Alterner les côtés souvent, descendre le bras entre deux passes.', kind: 'activite' },
  { name: 'Vie quotidienne — déménagement, port de meubles', groups: 'Érecteurs du rachis:1, Fléchisseurs des doigts:0.9, Grand fessier:0.8, Fléchisseurs avant-bras:0.8, Vaste latéral:0.8, Carré des lombes:0.7, Grand droit:0.7, Vaste médial:0.7, Obliques:0.6, Trapèze supérieur:0.6, Biceps fémoral:0.6, Multifides:0.5, Ischios internes:0.5, Droit fémoral:0.5, Biceps:0.5, Moyen fessier:0.5, Grand dorsal:0.4, Adducteurs:0.4, Brachial:0.4, Soléaire:0.3', sets: 1, reps: '60 min', notes: 'La séance de force qu’on ne voit pas venir. Plier les jambes, charge près du corps, et ne pas tourner le buste sous charge.', kind: 'activite' },
  { name: 'Vie quotidienne — monter des charges à l’étage', groups: 'Vaste latéral:1, Grand fessier:0.9, Cardio:0.8, Vaste médial:0.8, Droit fémoral:0.7, Fléchisseurs des doigts:0.7, Soléaire:0.6, Érecteurs du rachis:0.6, Fléchisseurs avant-bras:0.6, Gastrocnémiens:0.6, Carré des lombes:0.5, Moyen fessier:0.5, Trapèze supérieur:0.5, Biceps fémoral:0.5, Grand droit:0.5, Psoas-iliaque:0.4, Ischios internes:0.4', sets: 1, reps: '15 min', notes: 'Le plus cher de la liste, et de loin. ⚠️ Rotules : monter sans se jeter sur la marche, redescendre à vide si possible.', kind: 'activite' },
  ...
  { name: 'Béhourd — entraînement technique (sans armure)', groups: 'Deltoïde antérieur:0.8, Obliques:0.8, Fléchisseurs avant-bras:0.7, Cardio:0.7, Grand dorsal:0.6, Triceps latéral:0.6, Grand droit:0.6, Vaste latéral:0.5, Trapèze supérieur:0.5, Extenseurs du cou:0.5, Droit fémoral:0.4, Vaste médial:0.4, Coiffe des rotateurs:0.4, Deltoïde latéral:0.4, Grand fessier:0.4, Cou:0.4, Brachio-radial:0.4, Triceps longue portion:0.4', sets: 1, reps: '60 min', notes: 'Frappes à vide, footwork, drills à deux. ⚠️ AC droite : alterner les côtés, éviter les enchaînements prolongés bras haut.', kind: 'activite' },
  ...
  { name: 'Moto — grande balade (route)', groups: 'Extenseurs du cou:0.6, Érecteurs du rachis:0.5, Adducteurs:0.5, Cou:0.4, Vaste latéral:0.4, Vaste médial:0.4, Grand fessier:0.4, Trapèze supérieur:0.3, Multifides:0.3, Carré des lombes:0.3, Grand droit:0.3, Obliques:0.3, Gracile:0.3, Moyen fessier:0.3, Fléchisseurs des doigts:0.3, Fléchisseurs avant-bras:0.3, Scalènes:0.3, Tibial antérieur:0.3, Soléaire:0.3, Cardio:0.3', sets: 1, reps: '180 min', notes: 'Le mélange : des portions rapides où la nuque encaisse, des petites routes où les jambes travaillent. Speed Triple 1050, roadster nu, aucune protection au vent. Les genoux tiennent la moto et les bras restent souples — c’est la position qui permet de rouler trois heures sans avoir mal aux mains. Une pause toutes les heures, épaules relâchées sur les lignes droites. ⚠️ AC droite : ne pas verrouiller le bras droit sur le guidon, c’est lui qui encaisse les vibrations et le frein avant. ⚠️ Antéversion du bassin : les lombaires travaillent en extension prolongée — étirer les fléchisseurs de hanche à l’arrivée.', kind: 'activite' },
  { name: 'Moto — autoroute (vitesse stabilisée)', groups: 'Extenseurs du cou:0.7, Cou:0.5, Scalènes:0.5, Érecteurs du rachis:0.5, Adducteurs:0.5, Trapèze supérieur:0.4, Vaste latéral:0.4, Vaste médial:0.4, Multifides:0.3, Grand droit:0.3, Grand fessier:0.3, Fléchisseurs des doigts:0.3, Fléchisseurs avant-bras:0.3, Carré des lombes:0.3, Obliques:0.3, Moyen fessier:0.3, Cardio:0.3', sets: 1, reps: '90 min', notes: 'Le cou d’abord, mais sans exagérer : sur un roadster nu à vitesse stabilisée, le casque fait voile, la tête est tirée en arrière sans interruption et secouée par les turbulences. C’est l’entrée moto où la nuque encaisse le plus — mais elle reste loin sous le port du harnois, qui met 35 kg sur les épaules pendant une heure. Une autoroute FATIGUE le cou par la durée, elle ne le travaille pas : rien n’y est jamais dur, c’est le fait que ça ne s’arrête pas qui coûte. Mais ce sont les GENOUX qui encaissent la poussée du vent sur le buste : serrés sur le réservoir, ils dispensent les bras de retenir le corps, et c’est ce qui évite l’engourdissement d’avant-bras au bout d’une heure. Se coucher légèrement sur le réservoir décharge la nuque plus sûrement que n’importe quelle position de bras.', kind: 'activite' },
  { name: 'Moto — routes sinueuses (cols, petites routes)', groups: 'Adducteurs:0.7, Vaste latéral:0.6, Vaste médial:0.6, Grand fessier:0.6, Obliques:0.5, Gracile:0.5, Moyen fessier:0.5, Érecteurs du rachis:0.4, Multifides:0.4, Carré des lombes:0.4, Grand droit:0.4, Droit fémoral:0.4, Cardio:0.4, Extenseurs du cou:0.3, Cou:0.3, Fléchisseurs des doigts:0.3, Fléchisseurs avant-bras:0.3, Transverse:0.3, Rotateurs de hanche:0.3, Biceps fémoral:0.3, Soléaire:0.3, Tibial antérieur:0.3', sets: 1, reps: '90 min', notes: 'Les JAMBES pilotent. Genoux serrés sur le réservoir à chaque appui, appui sur les repose-pieds à chaque changement d’angle, cuisses qui encaissent le freinage : c’est l’entrée où les adducteurs travaillent le plus de tout le catalogue. Isométrie longue à bas niveau, jamais une poussée maximale : les valeurs restent loin sous une heure en armure, et sous une randonnée avec sac lesté. Peu de vent — la nuque redescend d’autant. Serrer fort aux genoux décharge directement les avant-bras : quand la main fatigue, c’est presque toujours que les jambes ne tiennent plus. ⚠️ Dysplasie rotulienne : appui sur les repose-pieds, jamais en torsion sur le genou.', kind: 'activite' },
  { name: 'Moto — trajet urbain', groups: 'Fléchisseurs des doigts:0.6, Adducteurs:0.6, Fléchisseurs avant-bras:0.4, Cou:0.3, Extenseurs du cou:0.3, Érecteurs du rachis:0.3, Vaste latéral:0.3, Vaste médial:0.3, Trapèze supérieur:0.3, Brachio-radial:0.3, Grand fessier:0.3, Grand droit:0.3, Tibial antérieur:0.3, Cardio:0.3', sets: 1, reps: '30 min', notes: 'Main et jambes à égalité, et c’est le seul cas : l’embrayage et le frein travaillent en continu, mais à allure de marche ce sont les jambes qui tiennent la moto sous soi à chaque arrêt et à chaque demi-tour. Léger — à ne pas confondre avec une balade, sinon le mannequin croit à une sortie qui n’a pas eu lieu.', kind: 'activite' },
  ...
  { name: 'Haussements d’épaules à la barre guidée', groups: 'Trapèze supérieur:1, Élévateur de la scapula:0.7, Trapèze moyen:0.4, Fléchisseurs avant-bras:0.4, Cou:0.4, Extenseurs du cou:0.4, Rhomboïdes:0.3', sets: 4, reps: '15', notes: 'Charge lourde possible sans lâcher la barre : idéal pour les trapèzes du harnois.' },
  ...
  { name: 'Haussements d’épaules à la barre', groups: 'Trapèze supérieur:1, Élévateur de la scapula:0.7, Trapèze moyen:0.4, Fléchisseurs avant-bras:0.4, Extenseurs du cou:0.4, Cou:0.3, Rhomboïdes:0.3, Extenseurs avant-bras:0.3', sets: 4, reps: '12' },
  ...
  { name: 'Portage frontal unilatéral (rack sur une épaule)', groups: 'Obliques:1, Carré des lombes:0.8, Grand droit:0.8, Érecteurs du rachis:0.6, Moyen fessier:0.6, Trapèze supérieur:0.5, Vaste latéral:0.4, Tenseur du fascia lata:0.4, Vaste médial:0.4, Fléchisseurs des doigts:0.4, Multifides:0.4, Transverse:0.4, Extenseurs du cou:0.4, Fléchisseurs avant-bras:0.3, Cou:0.3, Adducteurs:0.3, Droit fémoral:0.3, Biceps:0.3, Brachial:0.3, Soléaire:0.3', sets: 3, reps: '30 m/côté', notes: 'Charge asymétrique en hauteur : la ceinture encaisse tout. Très proche du port du bouclier.' },
...
export const EXERCISE_RENAMES: Record<string, string> = {
  ...
  'moto autoroute': 'Moto — autoroute (vitesse stabilisée)',
  'autoroute moto': 'Moto — autoroute (vitesse stabilisée)',
  'moto petite route': 'Moto — routes sinueuses (cols, petites routes)',
  'moto col': 'Moto — routes sinueuses (cols, petites routes)',
  ...
  // Le premier amorçage Basic Fit. Ces treize-là n'ont JAMAIS été raccordés à
  // la bibliothèque : ni renommés, ni complétés. Ils sont restés sur un libellé
  // à un seul mot — « Pectoraux », « Dos », « Fessiers » —, celui de la fiche
  // de salle d'origine, et ils sont encore dans les séances types.
  //
  // Plusieurs ne rataient la clé que d'un cheveu : « Pallof press » existait
  // déjà, mais la ligne s'appelle « Pallof press POULIE » ; « Mollets debout
  // machine » ne diffère de « Mollets debout (machine) » que par deux
  // parenthèses. Un renvoi manquant ne se voit pas — l'exercice s'affiche
  // normalement, il désigne juste la moitié des muscles qu'il travaille.
  'curl marteau (hammer)': 'Curl haltères marteau',
  'développé couché barre': 'Développé couché',
  'développé militaire (overhead press)': 'Développé militaire barre',
  'dips poitrine': 'Dips aux barres parallèles',
  'fentes haltères marchées': 'Fentes marchées haltères',
  'hanging knee raises': 'Relevés de genoux suspendu',
  'leg curl couché (ischios)': 'Flexion des ischios allongé (machine)',
  'mollets debout machine': 'Mollets debout (machine)',
  'pallof press poulie': 'Anti-rotation à la poulie (Pallof)',
  'presse à cuisses 45°': 'Presse à cuisses (pieds standard)',
  'rowing barre buste penché': 'Tirage buste penché à la barre',
  'russian twists lestées': 'Rotations russes',
  'tractions pronation lestées': 'Tractions pronation',
  // Trois noms portés par des séances types et des séances déjà faites, sans
  // renvoi nulle part. Le soulevé de terre « conventionnel » est le pire des
  // trois : étiqueté « Full body », il peignait les cinquante-quatre muscles à
  // 0,5 — supra-épineux et tibial postérieur compris — au lieu des vingt-deux
  // que la référence désigne.
